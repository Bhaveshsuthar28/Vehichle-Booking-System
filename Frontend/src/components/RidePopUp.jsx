...
export const RidePopUp = ({setridePopupPanel , setConfirmridePopupPanel , ride , confirmRide}) => {
  if(!ride) return null;
    ...
    <div className="relative w-full">
      ...
      <div className="flex flex-col gap-5 items-center w-full">
        ...
        <div className="flex w-full gap-4">
          ...
          <button onClick={() => {setConfirmridePopupPanel(true); setridePopupPanel(false) ; confirmRide()}} className="flex-1 bg-green-600 text-white text-lg font-semibold rounded-2xl py-2.5 

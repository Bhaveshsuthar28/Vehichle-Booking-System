...
export const VehiclePanel = ({setconfirmRidePanel , setvehiclePanelOpen , Fare , vehicleType}) => {
    ...
    return(
        <>
            ...
            <div onClick={() => {setconfirmRidePanel(true); setvehiclePanelOpen(false); vehicleType('car')}} className="flex items-center justify-between border-2 active:border-black rounded-2xl px-4 py-4 mb-3">
                <img
                ...
                <h2 className="text-xl font-bold text-gray-950">₹{Fare?.car}</h2>
            </div>

            
            <div onClick={() => {setconfirmRidePanel(true); setvehiclePanelOpen(false); vehicleType('bike')}} className="flex items-center justify-between border-2 active:border-black rounded-2xl px-4 py-4 mb-3">
                <img
                ...
                <h2 className="text-xl font-bold text-gray-950">₹{Fare?.bike}</h2>
            </div>

            <div onClick={() => {setconfirmRidePanel(true) ; setvehiclePanelOpen(false); vehicleType('auto')}} className="flex items-center justify-between border-2 active:border-black rounded-2xl px-4 py-4 mb-3">
                <img
                className="h-14 w-auto object-contain"
                ...
                <h2 className="text-xl font-bold text-gray-950">₹{Fare?.auto}</h2>
            </div>
        </>
    )
}
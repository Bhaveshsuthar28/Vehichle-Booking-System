...
import  ThreeDotsWave  from "./ThreeDotsWave.jsx";
                ...
                <div className="w-full">
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex flex-col m-2">
                            ...
                            {!!pickupParts.details && (
                                <p className="text-sm text-text-secondary">{pickupParts.details}</p>
                            )}
                        </div>
                    </div>
                    <div className="flex items-center gap-3 border-t-2 border-border-color">
                        <LocateFixed className="h-6 w-6" />
                        <div className="flex flex-col m-2">
                            <h3 className="text-lg font-semibold">{destinationParts.heading || 'Destination'}</h3>
                            {!!destinationParts.details && (
                                <p className="text-sm text-text-secondary">{destinationParts.details}</p>
                            )}
                        </div>
                    </div>
                    <div className="flex items-center gap-3 border-t-2 border-border-color mb-5">
